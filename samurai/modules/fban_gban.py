...
from samurai import CMD_HELP, bot, is_mongo_alive, is_redis_alive
from samurai.events import register, grp_exclude
from samurai.modules.dbhelper import (
    add_chat_fban,
    add_chat_gban,
    get_fban,
    get_gban,
...
from samurai.modules import helpers
...
async def gban_all(msg):
    ...
    message = f"\n`Gbanned on {str(count)} bot(s)!samurai doesn't check if the GBans were successful.`"
    await msg.edit(message)
